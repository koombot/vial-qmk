 ...
 * |  #   |  Z   |  X   |  C   |  V   |  B   | |  N   |  M   |  ,   |  .   |  /   |  \   |
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * | Ctrl |  Fn  | Alt  | Cmd  | Lowr | Entr | | Spac | Uppr | Left | Down |  Up  | Rght |
 * `-----------------------------------------' `-----------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_5x12(
    ...
    KC_LCTL,       KC_LALT,      KC_LALT,         KC_LGUI,       TL_LOWR,      KC_ENT,          LT(_NUMPAD,KC_SPC), TL_UPPR,      KC_LEFT,      KC_DOWN,      KC_UP,           KC_RGHT
),
 ...
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |   `  |   1  |   2  |   3  |   4  |   5  | |   6  |   7  |  Up  | PSCR | PGUP | F12  |
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * | Del  | (All)|      |      |      |      | |      | Left | Down | Rght |   ]  |  \   |
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |      |(Undo)|(Cut) |(Copy)|(Pste)|  F11 | |      |ISO # |ISO / |      | PGDN |      |
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |      |      |      |      |      |      | |      |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------' `-----------------------------------------'
 */
[_RAISE] = LAYOUT_ortho_5x12(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_5,          KC_F6,   KC_F7,     KC_F8,   KC_F9,   KC_F10, KC_F11,
    KC_GRV,  KC_1,    KC_2,    KC_3,    XXXXXXX, XXXXXXX,       XXXXXXX, KC_INSERT, KC_UP,   KC_PSCR, KC_PGUP, KC_F12,
    KC_DEL,  C(KC_A), KC_F2,   KC_F3,   XXXXXXX, XXXXXXX,       XXXXXXX, KC_LEFT,   KC_DOWN, KC_RGHT, KC_RBRC, KC_BSLS,
    _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), XXXXXXX,       XXXXXXX, KC_NUHS,   KC_NUBS, XXXXXXX, KC_PGDN, _______,
    _______, _______, _______, _______, _______, _______,       _______, _______,   KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_NUMPAD] = LAYOUT_ortho_5x12(
    ...
    KC_GRV,  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX, XXXXXXX,         KC_DEL,  KC_KP_7,     KC_KP_8,     KC_KP_9,        KC_KP_PLUS,  _______,
    KC_DEL,  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX, XXXXXXX,         XXXXXXX, KC_KP_4,     KC_KP_5,     KC_KP_6,        KC_KP_COMMA, XXXXXXX,
    _______, XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX, XXXXXXX,         XXXXXXX, KC_KP_1,     KC_KP_2,     KC_KP_3,        KC_KP_ENTER, _______,
    _______, _______, _______, _______, _______, _______,               _______, KC_KP_0,     KC_KP_DOT,   XXXXXXX,        XXXXXXX,     XXXXXXX
),
